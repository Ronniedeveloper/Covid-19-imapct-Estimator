...
const FrpApk = () => {
    return(
        <div className="apk-container">
            <div className="apk-wrapper">
                <div className="apk-content">
                    <h1>FRP BYPASS APK</h1>
                    <p>
                        Download and Bypass Frp on all Android Phone Starting from<br/>
                        Android 2.3.6 to Android 11 without a Computer and all apk<br/>
                        tools are free no cost.
                    </p>
                </div>
                <div className="title">
